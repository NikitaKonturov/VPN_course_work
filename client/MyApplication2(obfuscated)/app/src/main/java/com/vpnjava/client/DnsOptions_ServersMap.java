...
public class DnsOptions_ServersMap extends java.util.AbstractMap<Integer, DnsServer> {
  ...
  static public class Iterator {
    ...
    private boolean isNot(Iterator other) {
      return ovpncliJNI.DnsOptions_ServersMap_Iterator_isNot(swigCPtr, this, Iterator.getCPtr(other), other);
    }
  ...
  private void removeUnchecked(Iterator itr) {
    ovpncliJNI.DnsOptions_ServersMap_removeUnchecked(swigCPtr, this, Iterator.getCPtr(itr), itr);
  }
